...
# compatible with upstream Telegram Desktop. Which paths are filtered — and with
...
# would bump thousands of mtimes and force a full rebuild.
reapply() {
...
SOURCE_COUNT="$(reapply "(\"|//)(${STALE_HOST})([/\"])" 'Telegram/SourceFiles/*.cpp' 'Telegram/SourceFiles/*.h')"
STRINGS_COUNT="$(reapply "${STALE_HOST}" 'Telegram/Resources/langs/*.strings')"
